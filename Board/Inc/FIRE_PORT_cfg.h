...
//      模块通道    端口          可选范围                                    建议
#define UART0_RX_PIN    PTD6       //PTA1、PTA15、PTB16、PTD6、PTE21
#define UART0_TX_PIN    PTD7       //PTA2、PTA14、PTB17、PTD7、PTE20

#define UART1_RX_PIN    PTC3        //PTA18、PTE1、PTC3                       PTA18不要用 （与晶振冲突）
#define UART1_TX_PIN    PTC4        //PTA19、PTE0、PTC4                       PTA19不要用 （与晶振冲突）

#define UART2_RX_PIN    PTD4        //PTD2、PTD4、PTE17、PTE23
#define UART2_TX_PIN    PTD5        //PTD3、PTD5、PTE16、PTE22



/**********************************  TPM    ***************************************/

#define TPM_CLKIN0_PIN  PTE29//PTC12       //PTA18、PTB16、PTC12、PTE16、PTE29     PTA18不要用 （与晶振冲突）
...
#define TPM0_CH4_PIN    PTC8        //PTE31、PTA7、PTE31,PTD4
#define TPM0_CH5_PIN    PTC9        //PTE26、PTA0、PTE26、PTD5                 PTA0不要用（与SWD冲突）
...
#define TPM2_CH1_PIN    PTB19       //PTA2、PTB3、PTB3、PTE23
...
//      模块通道    端口          可选范围                                    建议
#define I2C0_SCL_PIN    PTB0        //PTC8 、PTB2、PTC8、PTE19、PTE24
#define I2C0_SDA_PIN    PTB1        // PTC9、PTB3、PTC9、PTE18、PTE25
